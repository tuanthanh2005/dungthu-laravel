                    ...
                    <div class="col-lg-5 d-none d-lg-block">
                        <div class="auth-left h-100">
                            <div>
                                ...
                                <p class="mb-4">Đăng nhập để trải nghiệm mua sắm tuyệt vời với hàng ngàn sản phẩm chất
                                    lượng.</p>
                        ...
                        <div class="auth-right">
                            ...
                            <form action="{{ route('login.post') }}" method="POST">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <a href="{{ route('password.request') }}"
                                        class="text-decoration-none text-primary fw-bold">Quên mật khẩu?</a>
                                </div>
                            ...
                            <div class="text-center mt-4">
                                <p class="text-muted mb-0">Chưa có tài khoản?
                                    <a href="{{ route('register') }}" class="text-primary fw-bold text-decoration-none">Đăng
                                        ký ngay</a>
                                </p>
                            </div>
                            ...
                            <div class="position-relative my-4">
                                <hr>
                                <span
                                    class="position-absolute top-50 start-50 translate-middle bg-white px-3 text-muted">Hoặc</span>
                            </div>

                            <a href="{{ url('/auth/google/redirect') }}"
                                class="btn btn-outline-danger w-100 py-3 rounded-pill fw-bold shadow-sm">
