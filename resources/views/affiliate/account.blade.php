            ...
            <div class="col-lg-9">
                ...
                <div class="content-card">
                    <div class="section-title">
                        <i class="fas fa-user-edit text-primary"></i> {{ __('Thông tin cá nhân') }}
                    </div>
                    ...
                    <form action="{{ route('affiliate.account.update') }}" method="POST">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label">{{ __('Chủ tài khoản') }}</label>
                ...
                <div class="content-card">
                    <div class="section-title">
                        <i class="fas fa-lock text-warning"></i> {{ __('Đổi mật khẩu') }}
                    </div>
                    ...
                    <form action="{{ route('affiliate.account.password') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label">{{ __('Xác nhận mật khẩu') }}</label>
                ...
                <div class="content-card border-start border-4 border-info">
                    <div class="section-title">
                        <i class="fas fa-id-card text-info"></i> {{ __('Thông tin định danh (CCCD)') }}
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="small text-muted mb-1">{{ __('Số CCCD') }}</div>
                            <div class="fw-bold">{{ $affiliate->cccd_number }}</div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="small text-muted mb-1">{{ __('Trạng thái tài khoản') }}</div>
                            <span class="badge bg-success">{{ __('Đã xác minh (Approved)') }}</span>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="small text-muted mb-2">{{ __('Mặt trước CCCD') }}</div>
                            <img src="{{ asset($affiliate->cccd_front) }}" class="img-fluid rounded" style="max-height: 150px; border: 1px solid #e2e8f0;">
                        </div>
                        <div class="col-md-6">
                            <div class="small text-muted mb-2">{{ __('Mặt sau CCCD') }}</div>
                    ...
                    <div class="mt-3 p-3 bg-light rounded small text-muted">
                        <i class="fas fa-info-circle"></i> {{ __('Thông tin định danh không thể tự thay đổi. Vui lòng liên hệ Admin nếu có sai sót.') }}
                    </div>
                </div>
            </div>
        </div>
