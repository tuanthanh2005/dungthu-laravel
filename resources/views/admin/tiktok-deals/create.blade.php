...
@section('title', 'Thêm Deal Tiktok')
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0"><i class="fab fa-tiktok"></i> Thêm Deal Tiktok Mới</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.tiktok-deals.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Lưu Deal
                            </button>
