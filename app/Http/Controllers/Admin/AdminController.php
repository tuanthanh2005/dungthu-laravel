...
class AdminController extends Controller
{
    ...
    public function storeProduct(Request $request)
    {
        $request->validate([
            ...
            'fake_sold' => 'nullable|integer|min:0',
        ...
        if (empty($specsEn) && $categoryType === 'ebooks') {
          ...
          $product = Product::create([
              ...
              'stock' => $request->stock,
              'fake_sold' => $request->input('fake_sold', 0),
            ...
            'show_on_banner' => $request->has('show_on_banner') ? true : false,
    ...
    public function verifyPin(Request $request)
    {
        ...
        if ($request->gate_password === $expectedPassword) {
            session([
                'admin_unlocked' => true,
