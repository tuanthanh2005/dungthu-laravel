            ...
            <form action="{{ route('admin.customer-durations.update', $customerDuration->id) }}" method="POST">
                ...
                <div class="card bg-light border-0 p-3 mb-4" style="border-radius: 12px;">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" name="is_completed" value="1" id="is_completed" {{ old('is_completed', $customerDuration->is_completed) ? 'checked' : '' }} style="width: 2.5em; height: 1.25em; cursor: pointer;">
                    ...
                    <div>
                        ...
                        <textarea name="admin_note" id="admin_note" class="form-control" rows="3" placeholder="Nhập ghi chú hoặc đánh dấu thông tin đơn hàng cho admin xem...">{{ old('admin_note', $customerDuration->admin_note) }}</textarea>
