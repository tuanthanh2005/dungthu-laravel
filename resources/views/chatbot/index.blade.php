    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                    <div id="chatbox" style="height: 500px; overflow-y: auto; border: 1px solid #ddd; padding: 15px; background-color: #f9f9f9; border-radius: 8px; margin-bottom: 20px;">
                    ...
                    <div class="input-group">
                        <input type="text" id="messageInput" class="form-control" placeholder="Hỏi tôi gì đó... (VD: Có sản phẩm nào về WordPress?)" />
                        <button class="btn btn-primary" id="sendBtn" type="button">
                            <span id="sendBtnText">Gửi</span>
                            <span id="sendBtnSpinner" class="spinner-border spinner-border-sm ms-2" style="display: none;"></span>
                        </button>
                    </div>

                    <small class="text-muted d-block mt-3">
                        ⚠️ Chatbot có thể không chính xác 100%. Vui lòng liên hệ support nếu cần hỗ trợ:
                        <br>📧 support@dungthu.com | ☎️ 0772698113 | 💬 Zalo: 0708910952
                    </small>
                </div>
            </div>
        </div>
