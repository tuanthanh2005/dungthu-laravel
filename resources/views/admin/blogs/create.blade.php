        ...
        <div class="admin-card">
            <div class="mb-4">
                <h3 class="fw-bold mb-2">
                    <i class="fas fa-plus-circle text-primary me-2"></i>Thêm Bài Viết Mới
                </h3>
                <p class="text-muted mb-0">Tạo bài viết mới cho blog của bạn</p>
            </div>
            ...
            <form action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control" id="excerpt" name="excerpt" 
                              rows="3" required 
                              placeholder="Nhập mô tả ngắn về bài viết...">{{ old('excerpt') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <select class="form-select" id="category" name="category" required>
                        ...
                        <option value="business" {{ old('category') == 'business' ? 'selected' : '' }}>Kinh doanh</option>
                ...
                <div class="mb-4">
                    ...
                    <small class="text-muted">Ảnh sẽ được tự động cắt về kích thước 500x334px</small>
                ...
                <div class="border-top pt-4 mt-4 mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="seo_title" name="seo_title" value="{{ old('seo_title') }}" placeholder="Nhập tiêu đề SEO (mặc định lấy tiêu đề bài viết)...">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="seo_description" name="seo_description" rows="3" placeholder="Nhập mô tả SEO (mặc định lấy mô tả ngắn)...">{{ old('seo_description') }}</textarea>
                        <div class="form-text">Mô tả tối ưu từ 150-160 ký tự.</div>
                    </div>

                    <div class="mb-3">
                        <label for="seo_keywords" class="form-label">Từ khóa SEO (Keywords)</label>
                        <input type="text" class="form-control" id="seo_keywords" name="seo_keywords" value="{{ old('seo_keywords') }}" placeholder="Ví dụ: chatgpt, ai, bot chat (cách nhau bởi dấu phẩy)...">
                    </div>
                </div>
