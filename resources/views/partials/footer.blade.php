        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content" style="border-radius: 20px; border: none;">
                ...
                <div class="modal-body p-4" style="font-size: 15px; line-height: 1.8; color: #4a5568;">
                    ...
                    <p>DungThu.com là một nền tảng cung cấp giải pháp công nghệ, thời trang và công cụ Marketing miễn
                        phí cho cộng đồng Việt Nam. Chúng tôi cam kết mang lại giá trị tốt nhất cho khách hàng với sản
                        phẩm chất lượng cao và giá cạnh tranh.</p>

                    <h6 class="fw-bold mb-3 mt-4" style="color: #667eea;">✨ Tại Sao Chọn DungThu?</h6>
                    <ul class="ms-3">
                        <li><strong>Sản phẩm chất lượng:</strong> Tất cả sản phẩm được kiểm định chất lượng trước khi
                            bán</li>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content" style="border-radius: 20px; border: none;">
                ...
                <div class="modal-body p-4" style="font-size: 15px; line-height: 1.8; color: #4a5568;">
                    ...
                    <p>Chúng tôi sử dụng mã hóa SSL/TLS cho tất cả giao tiếp và không chia sẻ thông tin cá nhân với bên
                        thứ ba.</p>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content" style="border-radius: 20px; border: none;">
                ...
                <div class="modal-body p-4" style="font-size: 15px; line-height: 1.8; color: #4a5568;">
                    ...
                    <p>DungThu.com có hàng ngàn khách hàng tiềm năng hàng tháng. Chúng tôi cung cấp các giải pháp quảng
                        cáo linh hoạt giúp thương hiệu của bạn tiếp cận khán giả chính xác.</p>
