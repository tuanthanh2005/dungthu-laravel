...
@section('title', 'Thêm Dịch Vụ - Admin')
...
<div class="container-admin">
    <div class="form-box">
        ...
        <form method="POST" action="{{ route('admin.buff.services.store') }}">
            @csrf
            ...
            <div class="form-row">
                ...
                <div class="form-group @error('service_type') has-error @enderror">
                    ...
                    <select name="service_type" class="form-control" required>
                        ...
                        <option value="like" @selected(old('service_type') === 'like')>Like</option>
                        <option value="follow" @selected(old('service_type') === 'follow')>Follow</option>
                        <option value="comment" @selected(old('service_type') === 'comment')>Comment</option>
                        <option value="view" @selected(old('service_type') === 'view')>View</option>
                    </select>
                    @error('service_type')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
            ...
            <div class="form-row">
                ...
                <div class="form-group @error('price_per_unit') has-error @enderror">
                    ...
                    <input type="number" name="price_per_unit" class="form-control"
                        step="1" min="0"
                        placeholder="0"
                        value="{{ old('price_per_unit', 0) }}" required>
            ...
            <div class="form-row">
                <div class="form-group @error('min_amount') has-error @enderror">
                    ...
                    <input type="number" name="min_amount" class="form-control"
                        min="1"
                        placeholder="10"
                        value="{{ old('min_amount', 10) }}" required>
                    @error('min_amount')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group @error('max_amount') has-error @enderror">
                    ...
                    <input type="number" name="max_amount" class="form-control"
                        min="1"
                        placeholder="1000000"
                        value="{{ old('max_amount', 1000000) }}" required>
                    @error('max_amount')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
