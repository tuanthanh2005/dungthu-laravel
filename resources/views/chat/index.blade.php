                    ...
                    <form id="chatForm" onsubmit="return false;" autocomplete="off">
                        ...
                        <div class="chat-input-wrapper">
                            ...
                            <div class="emoji-picker-container">
                                <button type="button" class="tool-btn" id="emojiToggleBtn" title="{{ __('Chọn emoji') }}">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    emojis.forEach(emoji => {
        ...
        span.addEventListener('click', function () {
            ...
            chatInput.value = textVal.substring(0, startPos) + emoji + textVal.substring(endPos, textVal.length);
            chatInput.focus();
    ...
    emojiToggleBtn.addEventListener('click', function (e) {
        e.stopPropagation();
        if (emojiPopover.style.display === 'flex') {
    ...
    document.addEventListener('click', function (e) {
        if (!emojiPopover.contains(e.target) && e.target !== emojiToggleBtn && !emojiToggleBtn.contains(e.target)) {
            emojiPopover.style.display = 'none';
        }
    });
