...
<label for="price" class="form-label">
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex gap-4">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="delivery_type" id="digital" value="digital" {{ old('delivery_type') == 'digital' ? 'checked' : '' }} required>
                ...
                <div class="border-top pt-4 mt-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="seo_title" name="seo_title" value="{{ old('seo_title') }}" placeholder="Nhập tiêu đề SEO (mặc định lấy tên sản phẩm)...">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="seo_description" name="seo_description" rows="3" placeholder="Nhập mô tả SEO (mặc định lấy mô tả sản phẩm)...">{{ old('seo_description') }}</textarea>
