...
@section('title', 'Chỉnh sửa Sản phẩm Công nghệ - Admin')
        ...
        <div class="admin-card" data-aos="fade-up">
            <div class="mb-4">
                ...
                <h3 class="fw-bold mb-0">
                    <i class="fas fa-edit text-info me-3"></i>Chỉnh sửa Sản phẩm Công nghệ
                </h3>
            </div>
                            ...
                            <div class="feature-checkbox">
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           value="physical" 
                                           {{ old('delivery_type', $product->delivery_type) == 'physical' ? 'checked' : '' }}
                                           required>
                            ...
                            <div class="feature-checkbox">
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           id="delivery_digital" 
                                           value="digital"
                                           {{ old('delivery_type', $product->delivery_type) == 'digital' ? 'checked' : '' }}
                                           required>
