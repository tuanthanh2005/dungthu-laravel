        ...
        <div class="container">
            ...
            <nav class="admin-nav" data-aos="fade-down">
                <ul class="nav nav-pills justify-content-center flex-wrap">
                    ...
                    <li class="nav-item">
                        <a class="nav-link protected-link" href="javascript:void(0)"
                    ...
                    <li class="nav-item">
                        <a class="nav-link protected-link" href="javascript:void(0)"
                            data-url="{{ route('admin.categories') }}">
                            <i class="fas fa-list me-2"></i>Danh mục
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link protected-link" href="javascript:void(0)"
                            data-url="{{ route('admin.products', ['flash_sale' => 1]) }}">
                            <i class="fas fa-bolt me-2"></i>Flash Sale
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link protected-link" href="javascript:void(0)"
                            data-url="{{ route('admin.tiktok-deals.index') }}">
                            <i class="fab fa-tiktok me-2"></i>Săn Sale TikTok
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link position-relative protected-link" href="javascript:void(0)"
                            data-url="{{ route('admin.orders') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link position-relative protected-link" href="javascript:void(0)"
                            data-url="{{ route('admin.card-exchanges') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link position-relative protected-link" href="javascript:void(0)"
                            data-url="{{ route('admin.chat.index') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link position-relative @if(request()->routeIs('admin.affiliates.*')) active @endif"
                    ...
                    <li class="nav-item">
                        <a class="nav-link position-relative protected-link" href="javascript:void(0)"
                            data-url="{{ route('admin.abandoned-carts') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link protected-link" href="javascript:void(0)"
                            data-url="{{ route('admin.system-notifications') }}">
                    ...
                    <div class="revenue-card text-center">
                        ...
                        <div id="revenue-overlay" class="revenue-locked-overlay">
                            ...
                            <div class="input-group mb-2" style="max-width: 250px;">
                                <input type="password" id="revenue-pass" class="form-control rounded-pill-start"
                    ...
                    <div class="admin-card">
                        ...
                        <div class="row g-3">
                            <div class="col-md-3 col-sm-6">
                                <a href="javascript:void(0)" data-url="{{ route('admin.products.create') }}"
                                    class="btn btn-outline-primary w-100 py-3 rounded-3 protected-link">
                                    <i class="fas fa-plus-circle d-block fs-3 mb-2"></i>
                                    Thêm sản phẩm
                                </a>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <a href="javascript:void(0)" data-url="{{ route('admin.products') }}"
                                    class="btn btn-outline-success w-100 py-3 rounded-3 protected-link">
                                    <i class="fas fa-list d-block fs-3 mb-2"></i>
                                    Quản lý sản phẩm
                                </a>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <a href="javascript:void(0)" class="btn btn-outline-info w-100 py-3 rounded-3"
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="{{ route('admin.menu-settings') }}"
                                    class="btn btn-outline-danger w-100 py-3 rounded-3">
                            ...
                            <tbody>
                                @foreach($latestOrders as $order)
                                    <tr>
                                        ...
                                        <td><strong
                                                class="text-primary">{{ number_format($order->total_amount, 0, ',', '.') }}đ</strong>
                                        </td>
                                        <td>
