...
@section('title', 'Thêm Tính Năng Nổi Bật - Admin')
            ...
            <form action="{{ route('admin.features.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                      ...
                                      placeholder="Detailed description of this feature in English...">{{ old('description_en') }}</textarea>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-4">
                            ...
                            <!-- Icon Preview -->
                            <div id="iconPreview" class="icon-preview" style="background: linear-gradient(135deg, #667eea, #764ba2);">
                ...
                <div class="d-flex gap-3 mt-4">
                    <button type="submit" class="btn btn-gradient">
                        <i class="fas fa-save me-2"></i>Lưu tính năng
                    </button>
                    <a href="{{ route('admin.features') }}" class="btn btn-secondary">
