        ...
        <form method="POST" action="{{ route('admin.buff.services.update', $buffService) }}">
            ...
            <div class="form-group @error('name_en') has-error @enderror">
                ...
                <input type="text" name="name_en" class="form-control"
                    ...
                    value="{{ old('name_en', $buffService->name_en) }}">
                @error('name_en')
                    <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group @error('description_en') has-error @enderror">
                ...
                <textarea name="description_en" class="form-control"
                    placeholder="Detailed description of service in English...">{{ old('description_en', $buffService->description_en) }}</textarea>
            ...
            <div class="form-row">
                <input type="hidden" name="base_price" value="{{ old('base_price', $buffService->base_price) }}">
