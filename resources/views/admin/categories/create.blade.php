        ...
        <div class="admin-card" data-aos="fade-up">
            <div class="mb-4">
                ...
                <h3 class="fw-bold mb-0">
                    <i class="fas fa-plus-circle text-primary me-3"></i>Thêm Danh mục
                </h3>
            </div>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <select class="form-select @error('type') is-invalid @enderror" name="type" id="type" required>
                        ...
                        <option value="tech" {{ old('type') === 'tech' ? 'selected' : '' }}>Công nghệ</option>
                        <option value="ebooks" {{ old('type') === 'ebooks' ? 'selected' : '' }}>Ebooks</option>
                        <option value="doc" {{ old('type') === 'doc' ? 'selected' : '' }}>Tài liệu</option>
                    </select>
                    @error('type')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="border-top pt-4 mt-4 mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="seo_title" name="seo_title" value="{{ old('seo_title') }}" placeholder="Nhập tiêu đề SEO (mặc định lấy tên danh mục)...">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="seo_description" name="seo_description" rows="3" placeholder="Nhập mô tả SEO (mặc định lấy mô tả danh mục)...">{{ old('seo_description') }}</textarea>
                        <div class="form-text">Mô tả tối ưu từ 150-160 ký tự.</div>
                    </div>

                    <div class="mb-3">
                        <label for="seo_keywords" class="form-label">Từ khóa SEO (Keywords)</label>
                        <input type="text" class="form-control" id="seo_keywords" name="seo_keywords" value="{{ old('seo_keywords') }}" placeholder="Ví dụ: laptop, tai lieu hoc tap, sach hay (cách nhau bởi dấu phẩy)...">
                    </div>
                </div>
